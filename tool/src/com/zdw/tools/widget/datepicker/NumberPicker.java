...
package com.zdw.tools.widget.datepicker;
...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectionDivider = attributesArray.getDrawable(R.styleable.NumberPicker_np_selectionDivider);
        ...
        mSelectionDividerHeight = attributesArray.getDimensionPixelSize(
                R.styleable.NumberPicker_np_selectionDividerHeight, defSelectionDividerHeight);
