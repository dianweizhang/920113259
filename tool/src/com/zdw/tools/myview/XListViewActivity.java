...
import com.zdw.tools.widget.xlistview.XListView;
import com.zdw.tools.widget.xlistview.XListView.IXListViewListener;
	...
	public void onRefresh() {
		mHandler.postDelayed(new Runnable() {
			...
			public void run() {
				...
				mAdapter = new ArrayAdapter<String>(XListViewActivity.this, R.layout.xlistview_item, items);
				mListView.setAdapter(mAdapter);
				onLoad();
			}
		}, 2000);
